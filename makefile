...
SegProp: init.o input.o main.o graphics.o player.o ennemi.o 
	gcc -o SegProp init.o input.o main.o graphics.o player.o ennemi.o `sdl-config --libs` -lSDL -lSDL_image -lSDL_ttf
